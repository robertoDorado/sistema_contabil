                                        ...
                                        <?php if (!empty($companyData)) : ?>
                                            <?php foreach ($companyData as $company) : ?>
                                                <tr>
                                                    ...
                                                    <td><a data-csrf="<?= session()->csrf_token ?>" data-company="<?= $company->company_name ?>" data-uuid="<?= $company->getUuid() ?>" class="icons trash-link" href="#"><i style="color:#ff0000" class="fa fa-trash" aria-hidden="true"></i></a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        <?php endif ?>
                                    </tbody>
