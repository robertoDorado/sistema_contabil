                                            ...
                                            <?php foreach ($cashFlowDataByUser as $cashFlowData) : ?>
                                                <?php if (!empty($cashFlowData->entry_type)) : ?>
                                                    <tr style="color:#008000">
                                                        ...
                                                        <td><a data-history="<?= $cashFlowData->getHistory() ?>" data-launchvalue="<?= $cashFlowData->getEntry() ?>" data-uuid="<?= $cashFlowData->getUuid() ?>" class="icons" href="#"><i class="fas fa-database" aria-hidden="true"></i></a></td>
                                                        <td><a data-history="<?= $cashFlowData->getHistory() ?>" data-launchvalue="<?= $cashFlowData->getEntry() ?>" data-uuid="<?= $cashFlowData->getUuid() ?>" class="icons" href="#"><i style="color:#ff0000" class="fa fa-trash" aria-hidden="true"></i></a></td>
                                                    </tr>
                                                <?php else : ?>
