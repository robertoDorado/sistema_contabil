...
/**
 * TaxRegimeModel Models
 * @link 
 * @author Roberto Dorado <robertodorado7@gmail.com>
 * @package Source\Models
 */
class TaxRegimeModel extends Model
{
    /** @var string uuid */
    ...
    /** @var string regime tributário da empresa */
    protected string $taxRegimeValue = "tax_regime_value";
    ...
    {
        parent::__construct(CONF_DB_NAME . ".tax_regime_model", ["id"], [
            $this->uuid,
            $this->idUser,
            $this->idCompany,
            $this->taxRegimeValue,
